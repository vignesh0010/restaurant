                    ...
                    <div class="container-fluid ps-2 pe-0">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            ...
                            <ul class="navbar-nav d-lg-flex d-none">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('login') }}"
                                        class="btn btn-sm mb-0 me-1 bg-gradient-dark">User Login</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center"
                                style="background-image: {{ asset('assets/img/illustrations/illustration-signup.jpg') }}; background-size: cover;">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                            <div class="card card-plain">
                                <div class="card-header">
                                    ...
                                    <p class="mb-0">Enter your email and password to Admin Login</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" action="{{ route('admin-auth') }}" method="POST">
                                        @csrf
